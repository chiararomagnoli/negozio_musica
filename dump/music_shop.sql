...
--
-- Host: 127.0.0.1
-- Creato il: Gen 04, 2024 alle 14:57
...
(2, 'Eko Guitars NXT D Blue Sunburst', 'Se il tuo obiettivo è quello di imparare a suonare la chitarra e sei alla ricerca di uno shape classico,la NXT D è la migliore delle scelte.Una chitarra entry level che ha tutto quello di cui hai bisogno per soddisfare i tuoi occhi e le tue orecchie.', 79.9, 9, NULL, 1, 2, 1, 'Nuovo'),
(3, 'Yamaha SG1820A CHITARRA ELETTRICA CON CASE BLACK', 'Hardware nero e parti nere che interrompono il colore monotono del corpo e creano un look moderno. Dotata di pickup EMG (EMG85 sulla parte frontale/EMG81 sulla parte posteriore) che producono un suono ben definito.', 2049.9, 1, NULL, 1, 3, 2, 'Usato'),
(4, 'Proel CS-10 Chitarra classica finitura Blue', 'CS-10 Blue Burst, tavola, fasce e fondo in Tiglio, Manico e tastiera in Betulla e finitura lucida, è la chitarra classica di Proel della serie Studio dedicata a tutti coloro che intendono avvicinarsi per la prima volta a questo strumento.', 65, 3, NULL, 1, 1, 3, 'Nuovo'),
(5, ' Huadong Kit Batteria Elettronica 7 Pad con Modulo Sonoro e Pelli Mesh', 'Huadong Kit include tutto ciò che ti occorre per iniziare a suonare la batteria: 4 pad con pelli mesh, 3 pad piatto, pedali per cassa e Hi-Hat, lo sgabello, le bacchette, una cuffia e i cavi.', 242, 3, NULL, 4, 9, 9, 'Nuovo'),
(6, 'Yamaha YBS480 Sax Baritono Discendente al La Laccato', '-Sax baritono in Mib\r\n-Discendente al La grave\r\n-Chiave del Fa# acuto\r\n-Finitura: ottone laccato\r\n-Campana incisa\r\n-Bocchino e custodia inclusi', 5898, 1, NULL, 5, 10, 2, 'Nuovo'),
(7, 'Carry-On BC2301 E11 Clarinetto Piccolo in Mib Ebano', 'Materiale: barilotto, corpo e campana in ebano, tonalità: Mib 442 Hz, chiavi/anelli: 17/6, argentate, completo di astuccio, bocchino, copri-bocchino, legatura, ance e panno pulizia', 1790, 2, NULL, 5, 12, 5, 'Usato'),
(8, 'Bontempi 4480 Mini Keyboard', 'Tastiera digitale a 44 tasti, 6 Canzoni preregistrate, 10 Suoni, 8 Ritmi, Tasti selezione suoni, ritmi, Polifonia 8 note, OKON (Funzione di apprendimento), Funzione di registrazione e riascolto, Gestione facilitata degli accordi (Easy chord), Effetti: Sus', 49.9, 10, NULL, 2, 5, 4, 'Nuovo'),
(9, 'Yamaha PSRF52 Tastiera Portatile 61 Tasti', 'La PSR-F52 è la tastiera perfetta per chi vuole imparare a suonare. Ha tutte le funzionalità di cui hai bisogno per la tua prima esperienza musicale. La PSR-F52 offre una solida base per chiunque voglia iniziare a suonare la tastiera.', 122, 3, NULL, 2, 5, 2, 'Usato'),
...
(13, 'STENTOR Violino Student 1 3/4 Settato', 'Strumento in acero e abete tutto massello realizzato con legni stagionati naturalmente da almeno tre anni. Piroli e mentoniera in Linden, cordiera in metallo con quattro intonatori incorporati e Corde Dogal R31 e pece Dogal.', 205, 2, NULL, 3, 6, 8, 'Usato'),
(14, 'Bruck Cello 3/4 HDC01 Laminato completo di arco e borsa', 'Violoncello HDC01 3/4, completo di archetto, borsa e pece, tavola in abete laminato, cordiera con 4 tiracantini, corde originali con il LA di qualità (sostituito dal liutaio)', 280, 5, NULL, 3, 7, 9, 'Nuovo'),
(15, 'VHIENNA MEISTER VH CES12', 'Top: Abete Massello Fondo/Fasce: Acero Laminato Tastiera: Ebanizzata Tendicordiera: Metallo con Mini Accordatori Archetto: Entry level plus, Colofonia Custodia: Blu', 550, 3, NULL, 3, 7, 7, 'Usato'),
(16, 'Eko Drums ED-200 Drum kit Metallic Blue - 5 pezzi', 'Batteria ad alte prestazioni per soddisfare le esigenze quotidiane. Lunga durata e affidabilità per dispositivi elettronici. Tecnologia avanzata per una ricarica veloce e sicura. Ideale per garantire la massima autonomia ai tuoi dispositivi.', 223, 4, NULL, 4, 8, 1, 'Nuovo'),
